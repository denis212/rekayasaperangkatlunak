...
$export_file = 'client-'.$clientid.'-'.$clientname.".xls";
ob_end_clean();
 ...
 <tr class=xl67 height=20 style='height:15.0pt'>
  ...
  <?php foreach ($page->items as $campaign): ?>
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       echo "<br><br>";
       echo $this->tag->linkTo(["campaign/downgbr120x600/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link20"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       echo "<br><br>";
       echo $this->tag->linkTo(["campaign/downgbr160x600/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link19"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       if($campaign->gbr250x250 != null)
       {
         ...
         echo "<br><br>";
         echo $this->tag->linkTo(["campaign/downgbr250x250/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link18"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       if($campaign->gbr300x50 != null)
       {
         ...
         echo "<br><br>";
         echo $this->tag->linkTo(["campaign/downgbr300x50/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link17"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       if($campaign->gbr300x250 != null)
       {
         ...
         echo "<br><br>";
         echo $this->tag->linkTo(["campaign/downgbr300x250/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link16"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       echo "<br><br>";
       echo $this->tag->linkTo(["campaign/downgbr300x100/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link15"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       if($campaign->gbr300x600 != null)
       {
         ...
         echo "<br><br>";
         echo $this->tag->linkTo(["campaign/downgbr300x600/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link14"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       if($campaign->gbr305x99 != null)
       {
         ...
         echo "<br><br>";
         echo $this->tag->linkTo(["campaign/downgbr305x99/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link13"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       if($campaign->gbr315x300 != null)
       {
         ...
         echo "<br><br>";
         echo $this->tag->linkTo(["campaign/downgbr315x300/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link12"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       echo "<br><br>";
       echo $this->tag->linkTo(["campaign/downgbr320x50/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link11"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       echo "<br><br>";
       echo $this->tag->linkTo(["campaign/downgbr320x100/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link10"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       echo "<br><br>";
       echo $this->tag->linkTo(["campaign/downgbr320x250/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link9"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       echo $this->tag->linkTo(["campaign/downgbr320x416/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link8"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       echo $this->tag->linkTo(["campaign/downgbr320x480/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link7"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       echo $this->tag->linkTo(["campaign/downgbr336x280/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link6"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       echo $this->tag->linkTo(["campaign/downgbr468x60/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link5"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       if($campaign->gbr640x960 != null)
       {
         ...
         echo $this->tag->linkTo(["campaign/downgbr640x960/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link4"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       if($campaign->gbr728x90 != null)
       {
         ...
         echo $this->tag->linkTo(["campaign/downgbr728x90/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link3"]);
       }
       else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       if($campaign->gbr800x440 != null)
       {
         ...
         echo $this->tag->linkTo(["campaign/downgbr800x440/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link2"]);
       }
       else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       ...
       if($campaign->gbr1024x768 != null)
       {
         ...
         echo $this->tag->linkTo(["campaign/downgbr1024x768/" . $campaign->id, "Download Image", "class"=>"btn","id"=>"link1"]);
       }else {
     ...
     <td class=xl65 style='border-top:none;border-left:none'>
       <!-- <php echo $this->tag->linkTo(["campaign/view/" . $campaign->id, "View", "class"=>"btn"]); ?> -->

       <?php echo $this->tag->linkTo(["campaign/edit/" . $campaign->id."/view", "Edit", "class"=>"btn"]); ?>
       <?php echo $this->tag->linkTo(["campaign/delete/" . $campaign->id."/".$page->current, "Delete", "class"=>"btn"]); ?>
       <?php
        if($campaign->status == "N")
          {
             echo $this->tag->linkTo(["campaign/activateview/" . $campaign->id, "Activate", "class"=>"btn"]);
           }
          elseif($campaign->status == "A")
           {
             echo $this->tag->linkTo(["campaign/activateview/" . $campaign->id,   "Deactivate", "class"=>"btn"]);
      ...
      <tbody>
          <tr>
              <td colspan="10" align="right">
                  <div class="btn-group">
                      <?= $this->tag->linkTo(['campaign/search', '<i class="icon-fast-backward"></i> First', 'class' => 'btn']) ?>
                      <?= $this->tag->linkTo(['campaign/search?page=' . $page->before, '<i class="icon-step-backward"></i> Previous', 'class' => 'btn ']) ?>
                      <?= $this->tag->linkTo(['campaign/search?page=' . $page->next, '<i class="icon-step-forward"></i> Next', 'class' => 'btn']) ?>
                      <?= $this->tag->linkTo(['campaign/search?page=' . $page->last, '<i class="icon-fast-forward"></i> Last', 'class' => 'btn']) ?>
  ...
  <table border=0 cellpadding=0 cellspacing=0 width=3335 style='border-collapse:
   ...
   <tr class=xl67 height=20 style='height:15.0pt'>
    ...
    <?php foreach ($page->items as $campaign): ?>
       ...
       <?php echo $this->tag->linkTo(["campaign/edit/" . $campaign->id."/".$page->current, "Edit", "class"=>"btn"]); ?>
       <?php echo $this->tag->linkTo(["campaign/delete/" . $campaign->id."/".$page->current, "Delete", "class"=>"btn"]); ?>
       <!-- <php
        if($campaign->status == "N")
          {
             echo $this->tag->linkTo(["campaign/activateview/" . $campaign->id ."/".$page->current, "Activate", "class"=>"btn"]);
           }
          elseif($campaign->status == "A")
           {
             echo $this->tag->linkTo(["campaign/activatview/" . $campaign->id ."/".$page->current, "Deactivate", "class"=>"btn"]);
