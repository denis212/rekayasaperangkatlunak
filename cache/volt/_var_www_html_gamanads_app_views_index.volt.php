      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="<?php if($ctrlname == "campaign" && ($action == "create" || $action == "search" || $action == "dailyreport")) {echo "active treeview";} else {echo "treeview";} ?>">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo ($action == "create") ? "active" : null; ?>"><?= $this->tag->linkTo(['campaign/create', '<i class="fa fa-circle-o"></i> Create Campaign']) ?></li>
              <li class="<?php echo ($action == "search") ? "active" : null; ?>"><?= $this->tag->linkTo(['campaign/search', '<i class="fa fa-circle-o"></i> List Campaign']) ?></li>
              <li class="<?php echo ($action == "dailyreport") ? "active" : null; ?>"><?= $this->tag->linkTo(['campaign/dailyreport', '<i class="fa fa-circle-o"></i> Daily Report']) ?></li>
            </ul>
          </li>
          <!-- publisher -->
          <li class="<?php if(($ctrlname == "adspace") && ($action == "create" || $action == "search")) {echo "active treeview";} else {echo "treeview";} ?>">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo ($action == "create") ? "active" : null; ?>"><?= $this->tag->linkTo(['adspace/create', '<i class="fa fa-circle-o"></i> Create Adspace']) ?></li>
              <li class="<?php echo ($action == "search") ? "active" : null; ?>"><?= $this->tag->linkTo(['adspace/search', '<i class="fa fa-circle-o"></i> List Adspace']) ?></li>
            </ul>
          </li>
          <!-- Payment -->
          <li class="<?php if(($ctrlname == "confirm") && ($action == "create" || $action == "search")) {echo "active treeview";} else {echo "treeview";} ?>">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo ($action == "create") ? "active" : null; ?>"><?= $this->tag->linkTo(['confirm/create', '<i class="fa fa-circle-o"></i> Confirmation']) ?></li>
              <li class="<?php echo ($action == "search") ? "active" : null; ?>"><?= $this->tag->linkTo(['confirm/search', '<i class="fa fa-circle-o"></i> List Payment']) ?></li>
            </ul>
          </li>
          <!-- change password -->
          <li class="<?php if($ctrlname == "users" && ($action == "accountInfo" || $action == "changePassword")) {echo "active treeview";} else {echo "treeview";} ?>">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo ($action == "accountInfo") ? "active" : null; ?>"><?= $this->tag->linkTo(['users/accountInfo', '<i class="fa fa-circle-o"></i> Account Information']) ?></li>
              <li class="<?php echo ($action == "changePassword") ? "active" : null; ?>"><?= $this->tag->linkTo(['users/changePassword', '<i class="fa fa-circle-o"></i> Change Password']) ?></li>
            </ul>
          </li>
        </ul>
      </section>
