    ...
    <div class="box box-primary" style="margin-top:20px;">
      <form method="post" autocomplete="off">
        ...
        <ul class="pager">
          ...
          <li class="pull-right">
            <?= $this->tag->submitButton(['Save', 'class' => 'btn btn-big btn-success', 'style' => 'margin-right:20px']) ?>
          </li>
        </ul>
        ...
        <div class="tab-pane" id="B">
          <p>
            <table class="table table-bordered table-striped" align="center">
              ...
              <tbody>
                <?php $v166640022132109814811iterated = false; ?><?php foreach ($user->successLogins as $login) { ?><?php $v166640022132109814811iterated = true; ?>
                <tr>
                  <td><?= $login->id ?></td>
                  <td><?= $login->ipAddress ?></td>
                  <td><?= $login->userAgent ?></td>
                </tr>
                <?php } if (!$v166640022132109814811iterated) { ?>
        ...
        <div class="tab-pane" id="C">
          <p>
            <table class="table table-bordered table-striped" align="center">
              ...
              <tbody>
                <?php $v166640022132109814811iterated = false; ?><?php foreach ($user->passwordChanges as $change) { ?><?php $v166640022132109814811iterated = true; ?>
                <tr>
                  <td><?= $change->id ?></td>
        ...
        <div class="tab-pane" id="D">
          <p>
            <table class="table table-bordered table-striped" align="center">
              ...
              <tbody>
                <?php $v166640022132109814811iterated = false; ?><?php foreach ($user->resetPasswords as $reset) { ?><?php $v166640022132109814811iterated = true; ?>
                <tr>
                  <th><?= $reset->id ?></th>
