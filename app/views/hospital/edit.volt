...
<div class="container" style=" margin-right: 25px; margin-left:25px; width:auto;">
  <div class="col-md-12">
    <div class="box box-primary" style="margin-top:20px;">
      ...
      <legend>Edit Data Hospital</legend>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-1">
              ...
              <?php
                if($form->pic_rs != null)
                {
                  echo $this->tag->image([$form->pic_rs,'width'=>'30px','id'=>'pic_rs']);
                }else {
                    echo "";
                }
              ?>
              <?php if($form->pic_rs != null) { ?>
                <br><a class="btn btn-primary btn-danger" <?php echo $this->tag->linkTo(['doctor/deletegambar/'.$form->id, 'Delete Photo']) ?></a>
              <?php }?>
            </div>
          </div>
