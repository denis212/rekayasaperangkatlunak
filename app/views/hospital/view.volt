<title>View Hospital - CMS Doctor</title>
...
<div class="row" style="margin-right:20px;">
    <nav>
        <ul class="pager">
            <li class="previous"><?php echo $this->tag->linkTo(["hospital/search?page=".$frompage, "Go Back"]); ?></li>
            <li class="next"><?php echo $this->tag->linkTo(["hospital/create", "Create ","style"=>"background-color:#c52d2f; color: #fff;"]); ?></li>
        </ul>
    </nav>
</div>

<div class="page-header" style="border-bottom: 1px solid #e4e2e0;">
    <h1>Hospital View Result</h1>
</div>
