...
<div class="container" style=" margin-right: 25px; margin-left:25px; width:auto;">
  <div class="col-md-12">
    <div class="box box-primary" style="margin-top:20px;">
      ...
      <legend>Edit Data Doctor Account</legend>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-1">
              ...
              <?php
                ...
                {
                  echo $this->tag->image([$form->doctor_photo,'width'=>'30px','id'=>'doctor_photo']);
                }else {
                    echo "";
                }
              ?>
              <?php if($form->doctor_photo != null) { ?>
                <br><a class="btn btn-primary btn-danger" <?php echo $this->tag->linkTo(['doctor/deletegambar/'.$form->doctor_id, 'Delete Photo']) ?></a>
              <?php }?>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-1">
              ...
              <?php
                ...
                {
                  echo $this->tag->image([$form->doctor_ktp,'width'=>'30px','id'=>'doctor_ktp']);
                }else {
                    echo "";
                }
              ?>
              <?php if($form->doctor_ktp != null) { ?>
                <br><a class="btn btn-primary btn-danger" <?php echo $this->tag->linkTo(['doctor/deletegambar/'.$form->doctor_id, 'Delete Photo']) ?></a>
              <?php }?>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-1">
              ...
              <?php
                ...
                {
                  echo $this->tag->image([$form->doctor_sim,'width'=>'30px','id'=>'doctor_sim']);
                }else {
                    echo "";
                }
              ?>
              <?php if($form->doctor_sim != null) { ?>
                <br><a class="btn btn-primary btn-danger" <?php echo $this->tag->linkTo(['doctor/deletegambar/'.$form->doctor_id, 'Delete Photo']) ?></a>
              <?php }?>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-1">
              ...
              <?php
                ...
                {
                  echo $this->tag->image([$form->doctor_kk,'width'=>'30px','id'=>'doctor_kk']);
                }else {
                    echo "";
                }
              ?>
              <?php if($form->doctor_kk != null) { ?>
                <br><a class="btn btn-primary btn-danger" <?php echo $this->tag->linkTo(['doctor/deletegambar/'.$form->doctor_id, 'Delete Photo']) ?></a>
              <?php }?>
            </div>
          </div>
