  ...
  <div>
    <form method='post'>
      <table>
        <tr>
          <td>
            {{form.label('doctor_email')}}
          </td>
          <td>{{form.label('doctor_msisdn')}}</td>
          <td>
...
<div class="row">
    ...
    <div class="col-md-3">
      <div class="btn-group">
          {{ link_to("doctor/search", '<i class="icon-fast-backward"></i> First', "class": "btn btn-info") }}
          {{ link_to("doctor/search?page=" ~ page.before, '<i class="icon-step-backward"></i> Previous', "class": "btn btn-info") }}
          {{ link_to("doctor/search?page=" ~ page.next, '<i class="icon-step-forward"></i> Next', "class": "btn btn-info") }}
          {{ link_to("doctor/search?page=" ~ page.last, '<i class="icon-fast-forward"></i> Last', "class": "btn btn-info") }}
