      ...
      <tbody>
          <tr>
              <td colspan="10" align="right">
                  <div class="btn-group">
                      {{ link_to("campaign/search", '<i class="icon-fast-backward"></i> First', "class": "btn") }}
                      {{ link_to("campaign/search?page=" ~ page.before, '<i class="icon-step-backward"></i> Previous', "class": "btn ") }}
                      {{ link_to("campaign/search?page=" ~ page.next, '<i class="icon-step-forward"></i> Next', "class": "btn") }}
                      {{ link_to("campaign/search?page=" ~ page.last, '<i class="icon-fast-forward"></i> Last', "class": "btn") }}
