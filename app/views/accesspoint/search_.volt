<title>Search Access Point - CMS Doctor</title>
...
<div class="row" style="margin-right:20px;">
    <nav>
        <ul class="pager">
            <li class="next"><?php echo $this->tag->linkTo(["accesspoint/create", "Create ","style"=>"background-color:#c52d2f; color: #fff;"]); ?></li>
        </ul>
    </nav>
</div>

<div class="page-header" style="border-bottom: 1px solid #e4e2e0;">
    <h1>List Access Point</h1>
</div>
...
<table border=0 cellpadding=0 cellspacing=0 width=3335 style='border-collapse:
 ...
 <tr class=xl67 height=20 style='height:15.0pt'>
  <td height=20 class=xl66 width=64 style='height:20.0pt;width:50%'>Doctor Email</td>
  <td class=xl66 width=64 style='border-left:none;width:50%'>No Handphone</td>
  <td class=xl66 width=64 style='border-left:none;width:50%'>Doctor Name</td>
  <td class=xl66 width=64 style='border-left:none;width:100%'>Expertise</td>
  <td class=xl66 width=175 style='border-left:none;width:100%'>Doctor Address</td>
  <td class=xl66 width=175 style='border-left:none;width:100%'>Doctor Salt</td>
  <td class=xl66 width=113 style='border-left:none;width:100%'>Doctor Status</td>
  <td class=xl66 width=229 style='border-left:none;width:100%'>Created</td>
  <td class=xl66 width=229 style='border-left:none;width:100%%'>Updated</td>
 </tr>
 <?php $i = 0; ?>
  <?php foreach ($page->items as $accesspoint): ?>
  <?php $i++;
        $sisa=$i%2;
  ...
  ?>
     <tr>
     <td height=20 class=<?php echo $css; ?> style='height:15.0pt;border-top:none'><?php echo $accesspoint->id_reseller ?></td>
     <td height=20 class=<?php echo $css; ?> style='height:15.0pt;border-top:none' ><?php echo $accesspoint->nama_agen ?></td>
     <td class=<?php echo $css; ?> style='border-top:none;border-left:none'><?php echo $accesspoint->merk?></td>
     <td class=<?php echo $css; ?> style='border-top:none;border-left:none'><?php echo $accesspoint->serial_number?></td>
     <td class=<?php echo $css; ?> style='border-top:none;border-left:none'><?php echo $accesspoint->lokasi ?></td>
     <td class=<?php echo $css; ?> style='border-top:none;border-left:none'><?php echo $accesspoint->alamat ?></td>
     <td class=<?php echo $css; ?> style='border-top:none;border-left:none'><?php echo $accesspoint->created ?></td>
     <td class=<?php echo $css; ?> style='border-top:none;border-left:none'><?php echo $accesspoint->updated ?></td>
     <td class=<?php echo $css; ?> style='border-top:none;border-left:none' width="12%">
       <?php echo $this->tag->linkTo(["accesspoint/view/" . $accesspoint->id ."/".$page->current, "<i class='glyphicon glyphicon-eye-open'></i> View", "class"=>"btn btn-info"]); ?>
       <?php echo $this->tag->linkTo(["accesspoint/edit/" . $accesspoint->id."/".$page->current, "<i class='glyphicon glyphicon-edit'></i> Edit", "class"=>"btn btn-primary"]); ?>
       <?php echo $this->tag->linkTo(["accesspoint/delete/" . $accesspoint->id."/".$page->current, "<i class='glyphicon glyphicon-remove'></i> Delete", "class"=>"btn btn-warning"]); ?>
     </td>
     </tr>
 <?php endforeach; ?>
