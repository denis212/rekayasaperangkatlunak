 ...
 <?php $i = 0; ?>
  ...
  ?>
     ...
     <td class=<?php echo $css; ?> style='border-top:none;border-left:none' width="12%">
       <?php echo $this->tag->linkTo(["schedule/view/" . $schedule->id ."/".$page->current, "<i class='glyphicon glyphicon-eye-open'></i> View", "class"=>"btn btn-info"]); ?>
...
<div class="row">
    ...
    <div class="col-md-3">
      <div class="btn-group">
          {{ link_to("schedule/search", '<i class="icon-fast-backward"></i> First', "class": "btn btn-info") }}
          {{ link_to("schedule/search?page=" ~ page.before, '<i class="icon-step-backward"></i> Previous', "class": "btn btn-info") }}
          {{ link_to("schedule/search?page=" ~ page.next, '<i class="icon-step-forward"></i> Next', "class": "btn btn-info") }}
          {{ link_to("schedule/search?page=" ~ page.last, '<i class="icon-fast-forward"></i> Last', "class": "btn btn-info") }}
