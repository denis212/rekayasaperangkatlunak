<title>Dashboard Reseller - GamanAds</title>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                  <div class="inner">
                    <h2><?php echo 'IDR '.number_format($tot_rev); ?></h2>
              ...
              <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-green">
                  <div class="inner">
                    <h2><?php echo 'IDR '.number_format($saldo); ?></h2>
