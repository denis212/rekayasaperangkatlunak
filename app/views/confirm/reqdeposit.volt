...
<div class="container" style=" margin-right: 25px; margin-left:25px; width:auto;">
  <div class="col-md-12">
    ...
    <div class="box box-primary" style="margin-top:20px;">
      ...
      <legend style="margin-left:15px;">Request Deposit</legend>
      <br>
      <div align="center">
        ...
        <form method='post' enctype='multipart/form-data' class="form-horizontal" autocomplete="off">
          ...
          <div class="form-group">
            <label class="col-md-4 control-label" for="textinput">{{ form.label('accbank') }}</label>
            <div class="col-md-4">
              {{ form.render('accbank',['class':'form-control']) }}
            </div>
          </div>
